layui.use(['layer', 'jquery', 'form'], function () {
    ...
    //dataJson.setSize('800px', '350px');     //设置代码框的长宽
    //dataJson.setValue("assss");    //给代码框赋值
    ...
    templateBodyEditor.setSize('100%', '600px');     //设置代码框的长宽
        //templateBody.setValue("aaaa");    //给代码框赋值
        //console.log(templateBody.getValue());    //获取代码框的值
        //$("#dataJson").text(templateBody.getValue());
    ...
    form.on('submit(form)', function (data) {
        ...
        $.post('/Message/TemplateType/Edit', data.field, function (res) {
            if (!res.success) {
