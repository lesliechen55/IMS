window.localStorage.setItem("cache", window.localStorage.getItem("cache") == null ? "true" : window.localStorage.getItem("cache"));
var cacheStr = window.localStorage.getItem("cache");
layui.use(['form', 'jquery', "layer"], function () {
        ...
        layer.open({
            ...
            success: function (index, layero) {
                ...
                form.on("submit(settingSuccess)", function (data) {
                    window.localStorage.setItem("cache", data.field.cache == "on" ? "true" : "false");
                    window.localStorage.setItem("changeRefresh", data.field.changeRefresh == "on" ? "true" : "false");
                    window.sessionStorage.removeItem("menu");
                    window.sessionStorage.removeItem("curmenu");
                    location.reload();
                    return false;
    ...
    if (window.localStorage.getItem("systemParameter")) {
        systemParameter = JSON.parse(window.localStorage.getItem("systemParameter"));
