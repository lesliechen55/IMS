...
{
    public class PermissionAddRequestValidator : AbstractValidator<PermissionAddRequest>
    {
        public PermissionAddRequestValidator()
        {
            ...
            {
                if (y.InstanceToValidate is PermissionAddRequest request)
                {
