...
{
    public class ProductSkuEditRequestValidator : AbstractValidator<ProductSkuEditRequest>
    {
        public ProductSkuEditRequestValidator()
        {
            ...
            {
                if (x.HasValue && x.Value && y.InstanceToValidate is ProductSkuEditRequest request)
                {
